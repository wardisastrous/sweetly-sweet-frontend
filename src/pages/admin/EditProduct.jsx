...
export default function EditProduct() {
  ...
  async function uploadImages() {
    ...
    try {
      ...
      await axiosInstance.put(`/api/admin/products/${id}`, {
        name: form.name,
          ...
          <div className="bg-white border border-beige-200 p-6 shadow-sm">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-3 mb-3">
              ...
              {previews.map((src, i) => (
                <div
                  key={i}
                  className="relative aspect-square border border-beige-300 overflow-hidden"
                >
                  <img
                    src={src}
                    alt=""
              ...
              <label
                className={
                  "aspect-square border-2 border-dashed border-beige-300 flex flex-col items-center justify-center cursor-pointer hover:border-forest-400 transition-colors" +
                  (isBusy
              ...
              >
                <ImagePlus
                  size={20}
                  className="text-beige-400 mb-1"
                />

                <span className="text-[10px] font-mono text-beige-500 uppercase tracking-wide">
                  Replace Images
                </span>
