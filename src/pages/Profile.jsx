...
import { Save, User, Package, MapPin } from "lucide-react";
      ...
      <div className="max-w-[700px] mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-4">
        ...
        <div className="bg-white border border-beige-200 p-6 shadow-sm">
          <div className="flex items-center gap-5 mb-8">
            ...
            <div>
              <p className="font-display text-[#1a1a1a] text-xl font-semibold">
                {user?.name}
              </p>

              <p className="text-[#6a6a6a] text-sm font-mono mt-0.5">
                {user?.email}
              </p>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs font-mono text-[#9a9a9a] mt-1.5 tracking-wide">
        ...
        <div className="bg-white border border-beige-200 p-6 shadow-sm">
          <h2 className="text-xs font-mono tracking-widest uppercase text-[#6a6a6a] mb-4">
            Quick Links
          </h2>

          <Link
            to="/orders"
            className="flex items-center justify-between py-3 border-b border-beige-100 group"
          >
            <div className="flex items-center gap-3">
              <Package
                size={16}
                className="text-beige-400 group-hover:text-forest-500 transition-colors"
              />

              <span className="text-sm text-[#4a4a4a] group-hover:text-forest-600 transition-colors">
                My Orders
              </span>
            </div>
